...
const Accessibility = () => {
  ...
  const accessibilityStructuredData = {
    ...
    "@type": "Service",
    "name": "Website Accessibility & ADA Compliance Services",
    ...
    "serviceType": "Website Accessibility & ADA Compliance Services",
    "areaServed": "United States",
    "url": "https://lunaratech.com/accessibility-services"
};
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#70CBD0]/10 to-[#70CBD0]/5">
      <SEOHead 
        ...
        canonicalUrl="https://lunaratech.com/accessibility-services"
